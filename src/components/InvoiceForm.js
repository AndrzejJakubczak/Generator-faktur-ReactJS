      ...
      <Row>
          ...
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            <div className="d-flex flex-row align-items-start justify-content-between mb-3">
              <div class="d-flex flex-column">
                <div className="d-flex flex-column">
                  <div class="mb-2">
                    <span className="fw-bold">Aktualna&nbsp;data:&nbsp;</span>
                    <span className="current-date">{new Date().toLocaleDateString()}</span>
                  </div>
                </div>
                <div className="d-flex flex-row align-items-center">
                  <span className="fw-bold d-block me-2">Data&nbsp;wystawienia faktury:</span>
            ...
            <Row className="mb-5">
              <Col>
                ...
                <Form.Control placeholder={"Nazwa firmy"} rows={3} value={this.state.billTo} type="text" name="billTo" className="my-2" onChange={(event) => this.editField(event)} autoComplete="name" required="required"/>
                <Form.Control placeholder={"Adres e-mail"} value={this.state.billToEmail} type="email" name="billToEmail" className="my-2" onChange={(event) => this.editField(event)} autoComplete="email" required="required"/>
                <Form.Control placeholder={"Adres rozliczeniowy"} value={this.state.billToAddress} type="text" name="billToAddress" className="my-2" autoComplete="address" onChange={(event) => this.editField(event)} required="required"/>
              </Col>
              <Col>
                <Form.Label className="fw-bold">Nabywca:</Form.Label>
                <Form.Control placeholder={"Nazwa firmy"} rows={3} value={this.state.billFrom} type="text" name="billFrom" className="my-2" onChange={(event) => this.editField(event)} autoComplete="name" required="required"/>
                <Form.Control placeholder={"Adres e-mail"} value={this.state.billFromEmail} type="email" name="billFromEmail" className="my-2" onChange={(event) => this.editField(event)} autoComplete="email" required="required"/>
                <Form.Control placeholder={"Adres rozliczeniowy"} value={this.state.billFromAddress} type="text" name="billFromAddress" className="my-2" autoComplete="address" onChange={(event) => this.editField(event)} required="required"/>
              </Col>
            </Row>
            ...
            <Row className="mt-4 justify-content-end">
              <Col lg={6}>
                <div className="d-flex flex-row align-items-start justify-content-between">
                  <span className="fw-bold">Wartość netto:
                  </span>
                ...
                <div className="d-flex flex-row align-items-start justify-content-between mt-2">
                  ...
                  <span>
                    ...
                    {this.state.discountAmmount || 0} {this.state.currency}</span>
                </div>
                <div className="d-flex flex-row align-items-start justify-content-between mt-2">
                  <span className="fw-bold">Podatek:
                  </span>
                  <span>
                ...
                <div className="d-flex flex-row align-items-start justify-content-between" style={{
                  ...
                  <span className="fw-bold">Wartość brutto:
                  </span>
            ...
            <hr className="my-4"/>
            <Form.Label className="fw-bold">Uwagi:</Form.Label>
        ...
        <Col md={4} lg={3}>
          <div className="sticky-top pt-md-3 pt-xl-4">
            <Button variant="primary" type="submit" className="d-block w-100">Podgląd faktury</Button>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Select onChange={event => this.onCurrencyChange({currency: event.target.value})} className="btn btn-light my-1" aria-label="Change Currency">
                <option value="zł">PLN (Złoty polski)</option>
            ...
            <Form.Group className="my-3">
              <Form.Label className="fw-bold">Wartość podatku:</Form.Label>
            ...
            <Form.Group className="my-3">
              <Form.Label className="fw-bold">Wartość rabatu:</Form.Label>
              <InputGroup className="my-1 flex-nowrap">
