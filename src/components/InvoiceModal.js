          ...
          <div id="invoiceCapture">
            <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-4">
              ...
              <div className="text-end ms-4">
                <h6 className="fw-bold mt-1 mb-2">Kwota do zapłaty:</h6>
            ...
            <div className="p-4">
              <Row className="mb-4">
                ...
                <Col md={4}>
                  <div className="fw-bold mt-2">Data wystawienia faktury:</div>
              ...
              <Table className="mb-0">
                <thead>
                  <tr>
                    ...
                    <th className="text-end">Cena/Wartość</th>
                  ...
                  {this.props.items.map((item, i) => {
                    return (
                      <tr id={i} key={i}>
                        ...
                        <td className="text-end" style={{width: '100px'}}>{item.price} {this.props.currency}</td>
                        <td className="text-end" style={{width: '100px'}}>{item.price * item.quantity} {this.props.currency}</td>
                      </tr>
                    );
                  })}
                </tbody>
              ...
              <Table>
                <tbody>
                  ...
                  <tr className="text-end">
                    <td></td>
                    <td className="fw-bold" style={{width: '100px'}}>Wartość netto</td>
                  ...
                  {this.props.taxAmmount != 0.00 &&
                    <tr className="text-end">
                      ...
                      <td className="text-end" style={{width: '100px'}}>{this.props.taxAmmount} {this.props.currency}</td>
                    </tr>
                  }
                  {this.props.discountAmmount != 0.00 &&
                    <tr className="text-end">
                      ...
                      <td className="text-end" style={{width: '100px'}}>{this.props.discountAmmount} {this.props.currency}</td>
                    </tr>
                  }
                  <tr className="text-end">
                    <td></td>
                    <td className="fw-bold" style={{width: '100px'}}>Wartość brutto</td>
